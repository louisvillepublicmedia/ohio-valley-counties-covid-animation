...
},{}],"data/ohioCounties.json":[function(require,module,exports) {
module.exports="/ohioCounties.a24942a6.json";
},{}],"scripts/ohCovid-simulation.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#covid-simulation').attr('viewBox', [0, 0, width, height]).append('svg') //   .style('background-color', 'steelblue')
...
function mouseOver(d, i) {
  ...
  tooltip.attr('data-html', 'true').style('visibility', 'visible').html("<div class='row'><b>".concat(d.properties.NAME, " County</div>"));
...
function mouseMove(d, widthEl) {
  ...
  var offset = d3.select('#covid-simulation').node().getBoundingClientRect().x;
...
var index = 0;
var delay = 1;
Promise.all([d3.json(require("/data/ohioCounties.json")), d3.csv("https://raw.githubusercontent.com/nytimes/covid-19-data/master/us-counties.csv")]).then(ready).catch(function (err) {
...
function ready(_ref) {
  ...
  var counties = topojson.feature(json, json.objects.ohioCounties);
  ...
  function casesMap() {
    map.transition().attr('fill', function (d) {
      return getFilteredData().get(d.properties.GEOID) // ? colorScale(+getFilteredData().get(d.properties.GEOID).cases)
      // : '#fff'
  ...
  d3.select('#deaths-layer').on('click', function () {
    ...
    function deathsMap() {
      map.transition().attr('fill', function (d) {
        return getFilteredData().get(d.properties.GEOID) // ? colorScale(+getFilteredData().get(d.properties.GEOID).deaths)
        // : '#fff'
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","Scrubber":"../node_modules/Scrubber/index.js","/data/ohioCounties.json":"data/ohioCounties.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/ohCovid-simulation.js"], null)
//# sourceMappingURL=/ohCovid-simulation.5cb0bb84.js.map