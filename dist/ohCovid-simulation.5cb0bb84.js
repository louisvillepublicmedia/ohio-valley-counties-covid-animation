...
var svg = d3.select('#covid-simulation').attr('viewBox', [0, 0, width, height]).append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); //////////////////////////////////////////////////////////////// TOOLTIP////////////////////////////////
...
var index = 0;
var delay = 1;
Promise.all([d3.json(require("/data/ohioCounties.json")), d3.csv("https://raw.githubusercontent.com/louisvillepublicmedia/ohio-valley-counties-covid-animation/main/ohio-counties-covid-data.csv")]).then(ready).catch(function (err) {
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","Scrubber":"../node_modules/Scrubber/index.js","/data/ohioCounties.json":"data/ohioCounties.json"}]},{},["scripts/ohCovid-simulation.js"], null)
