...
var index = 0;
var delay = 1;
Promise.all([d3.json(require("/data/westvirginiaCounties.json")), d3.csv("https://raw.githubusercontent.com/louisvillepublicmedia/ohio-valley-counties-covid-animation/main/west-virginia-counties-covid-data.csv")]).then(ready).catch(function (err) {
...
function ready(_ref) {
  ...
  function render() {
    ...
    svg.selectAll('.county').attr('d', path); //   // send the height to our embed
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","Scrubber":"../node_modules/Scrubber/index.js","/data/westvirginiaCounties.json":"data/westvirginiaCounties.json"}]},{},["scripts/wvCovid-simulation.js"], null)
