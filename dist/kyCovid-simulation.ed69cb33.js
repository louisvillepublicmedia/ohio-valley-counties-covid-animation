...
},{}],"data/kentuckyCounties.json":[function(require,module,exports) {
module.exports="/kentuckyCounties.b455edad.json";
},{}],"scripts/kyCovid-simulation.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#ky-covid-simulation').attr('viewBox', [0, 0, width, height]).append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); //////////////////////////////////////////////////////////////// TOOLTIP////////////////////////////////
...
function mouseMove(d, widthEl) {
  ...
  var offset = d3.select('#ky-covid-simulation').node().getBoundingClientRect().x;
...
var parseTime = d3.timeParse('%Y-%m-%d'); // Geo Scale//
...
var index = 0;
var delay = 1;
Promise.all([d3.json(require("/data/kentuckyCounties.json")), d3.csv("https://raw.githubusercontent.com/nytimes/covid-19-data/master/us-counties.csv")]).then(ready).catch(function (err) {
...
function ready(_ref) {
  ...
  var counties = topojson.feature(json, json.objects.kentuckyCounties);
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","Scrubber":"../node_modules/Scrubber/index.js","/data/kentuckyCounties.json":"data/kentuckyCounties.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/kyCovid-simulation.js"], null)
//# sourceMappingURL=/kyCovid-simulation.ed69cb33.js.map