...
var index = 0;
var delay = 1;
Promise.all([d3.json(require("/data/kentuckyCounties.json")), d3.csv("https://raw.githubusercontent.com/louisvillepublicmedia/ohio-valley-counties-covid-animation/main/kentucky-counties-covid-data.csv")]).then(ready).catch(function (err) {
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","Scrubber":"../node_modules/Scrubber/index.js","/data/kentuckyCounties.json":"data/kentuckyCounties.json"}]},{},["scripts/kyCovid-simulation.js"], null)
